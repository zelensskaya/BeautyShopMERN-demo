...
const updateOrderToPaid = asyncHandler(async (req, res) => {
  ...
  // the order as paid
  console.log('Payment verification started for order:', req.params.id);
  console.log('Request body:', req.body);
  
  try {
    const { verified, value } = await verifyPayPalPayment(req.body.id);
    console.log('PayPal verification result - verified:', verified, 'value:', value);
    ...
    console.log('Found order:', order._id, 'totalPrice:', order.totalPrice, 'type:', typeof order.totalPrice);
    ...
    if (order) {
      ...
      console.log('Order marked as paid and saved');
